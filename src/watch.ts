...
export type WatchDecorator<K extends string> =
  <T>(target: {[k in K]?: T}, key: string, prop: ReadonlyPropertyDescriptor<WatchHandler<T>>) => void
export type WatchDecorator2<K1 extends string, K2 extends string> =
  <T>(target: {[k1 in K1]?: {[k2 in K2]?: T}}, key: string, prop: ReadonlyPropertyDescriptor<WatchHandler<T>>) => void
export type WatchDecorator3<K1 extends string, K2 extends string, K3 extends string> =
  <T>(target: {[k1 in K1]?: {[k2 in K2]?: {[k3 in K3]?: T}}}, key: string, prop: ReadonlyPropertyDescriptor<WatchHandler<T>>) => void
export type WatchDecorator4<K1 extends string, K2 extends string, K3 extends string, K4 extends string> =
  <T>(target: {[k1 in K1]?: {[k2 in K2]?: {[k3 in K3]?: {[k4 in K4]?: T}}}}, key: string, prop: ReadonlyPropertyDescriptor<WatchHandler<T>>) => void
